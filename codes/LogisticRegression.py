# -*- coding: utf-8 -*-
"""
Created on Wed Jun 11 17:55:16 2025
...
df = df.drop(['num_significant', 'extend_p', 'normalized_citations', 'Venue_SJR', 'coCite3', 'avg_high_inf_cites'], axis = 1) 
...
if data_type== 1:        # automatically extracted, citation data included
    ...
    X = X.drop(['num_citations', 'self_citations', 'citationVelocity', 'influentialCitationCount', 'citations_result', 'citations_methodology',
...
if data_type==1 or 2:
    #model = LogisticRegression(C=10, penalty='l1', solver='liblinear', max_iter= 100)
    model = LogisticRegression(C=1, penalty='l2', solver='liblinear', max_iter= 100)   
