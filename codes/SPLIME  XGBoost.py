# -*- coding: utf-8 -*-
"""
Created on Mon Jun 16 05:25:58 2025
...
sp_exp = submodular_pick.SubmodularPick( explainer, X_test.values, model.predict_proba, 
                                        num_features=10, 
                                        num_exps_desired=5, 
                                        num_samples=1000          
                                        ) 
...
#plt.title(f"Representative Sample {i+1}") 
#plt.tight_layout() 
#plt.show()

print('=====================4')      
non_redudant_global_exps = sp_exp.sp_explanations
